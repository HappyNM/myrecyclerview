...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //adding images
        list.add(Model("Facebook", "facebook description", R.drawable.ftyuk))
        list.add(Model("Whatsapp", "Whatsapp description", R.drawable.me))
        list.add(Model("Youtube", "youtube description", R.drawable.nairobi))
        list.add(Model("Instagram", "instagram description", R.drawable.nduthi))
        list.add(Model("Twitter", "Twitter description", R.drawable.mtu))
